...
export default function BlotterUnresolvedFormCard() {
  const navigate = useNavigate();

  const BlotterUnresolvedFormSchema = Yup.object().shape({
  ...
  const formik = useFormik({
    ...
    validationSchema: BlotterUnresolvedFormSchema,
    onSubmit: (data) => {
      console.log({ data });
      createOfficial(data)
